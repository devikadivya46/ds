...
export default function PatientInspectPane({ patient, onClose, onEdit }: PatientInspectPaneProps) {
  ...
  return (
    <aside className="hidden xl:flex w-[420px] shrink-0 flex-col border-l border-slate-100 bg-white rounded-3xl p-5 shadow-card sticky top-24 max-h-[calc(100vh-112px)] overflow-y-auto custom-scrollbar">
      ...
      <div className="mt-4 bg-white border border-slate-100 rounded-[24px] p-3 shadow-sm">
        <div className="flex items-center justify-between gap-2 border-b border-slate-200/70 pb-3">
          <div className="flex items-center gap-3">
            <button
              type="button"
              onClick={() => setActiveTab('overview')}
              className={`text-xs font-black uppercase tracking-widest ${activeTab === 'overview' ? 'text-blue-700' : 'text-slate-400 hover:text-slate-600'}`}
            >
              Overview
            </button>
            <button
              ...
              className={`text-xs font-black uppercase tracking-widest ${activeTab === 'careTeam' ? 'text-blue-700' : 'text-slate-400 hover:text-slate-600'}`}
            >
              Care Team
            </button>
            <button
              ...
              className={`text-xs font-black uppercase tracking-widest ${activeTab === 'timeline' ? 'text-blue-700' : 'text-slate-400 hover:text-slate-600'}`}
            >
              Timeline
            </button>
            <button
              ...
              className={`text-xs font-black uppercase tracking-widest ${activeTab === 'documents' ? 'text-blue-700' : 'text-slate-400 hover:text-slate-600'}`}
            >
              Documents
            </button>
          </div>
