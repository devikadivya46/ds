...
export default function App() {
  ...
  const handleRemoveFilterTag = (type: keyof ActiveFilters, value?: string) => {
    ...
    if (type === 'doctor' || type === 'department' || type === 'startDate' || type === 'endDate') {
      (updated as any)[type] = '';
  ...
  const filteredPatients = patients.filter(p => {
    ...
    const matchesDoctor = !activeFilters.doctor || p.attendingDoctor === activeFilters.doctor;
    const matchesDept = !activeFilters.department || p.department === activeFilters.department;
    ...
    return matchesSearch && matchesDoctor && matchesDept && matchesStatus && matchesLabel && matchesDate;
  });
